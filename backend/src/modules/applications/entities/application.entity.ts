import { Column, CreateDateColumn, Entity, Index, OneToMany, OneToOne, PrimaryGeneratedColumn, UpdateDateColumn, VersionColumn } from 'typeorm';
...
export class Application {
  ...
  @Column({ name: 'assigned_to', type: 'bigint', unsigned: true, nullable: true }) assignedTo?: number;
  ...
  @OneToOne(() => CustomerProfile, (profile) => profile.application) customerProfile?: CustomerProfile;
  @OneToMany(() => ContactPerson, (contact) => contact.application) contactPersons?: ContactPerson[];
  @OneToMany(() => CoApplicant, (coApplicant) => coApplicant.application) coApplicants?: CoApplicant[];
  @OneToMany(() => Document, (document) => document.application) documents?: Document[];
  @OneToOne(() => Workflow, (workflow) => workflow.application) workflow?: Workflow;
}
