...
@Column({ name: 'email_verified', default: false })emailVerified: boolean;
  ...
  @Column({ name: 'next_follow_up_date', type: 'varchar', length: 30, nullable: true }) nextFollowUpDate?: string;
  @Column({ name: 'follow_up_time', type: 'varchar', length: 30, nullable: true }) followUpTime?: string;
  @Column({ name: 'follow_up_notes', type: 'text', nullable: true }) followUpNotes?: string;
  @Column({ name: 'follow_up_status', type: 'varchar', length: 50, nullable: true, default: 'PENDING' }) followUpStatus?: string;
